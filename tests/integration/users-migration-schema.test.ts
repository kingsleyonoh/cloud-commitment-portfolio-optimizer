...
describe("credential-free users schema", () => {
  ...
  it("uses its own update function and trigger", async () => {
    ...
    expect(functions.rows.map(({ name }) => name)).toEqual([
      ...
      "enforce_ecosystem_event_lifecycle",
      "enforce_forecast_model_lifecycle",
      "enforce_forecast_run_lifecycle",
      "enforce_notification_lifecycle",
      "enforce_notification_preference_lifecycle",
      "enforce_optimizer_policy_lifecycle",
      "enforce_optimizer_run_lifecycle",
      "enforce_price_table_item_snapshot",
      "enforce_price_table_version_lifecycle",
      "enforce_recommendation_lifecycle",
      "enforce_report_snapshot_lifecycle",
      "enforce_scenario_lifecycle",
      "forecast_scope_is_canonical",
      "mark_auth_refresh_token_used",
      "optimizer_text_array_is_canonical",
      "optimizer_uuid_array_is_canonical",
