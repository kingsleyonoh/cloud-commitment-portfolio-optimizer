...
| `apps/web/` | HTMX server-rendered UI templates/routes | Current for error pages, `/login`, and `/dashboard`; remaining P1 product screens are planned |
