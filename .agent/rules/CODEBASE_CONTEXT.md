...
| `core/forecasting/` | Forecast models and scenario generation | Current for seasonal-naive model metadata and queued forecast runs; worker execution and quality metrics remain planned |
...
| Forecasting | `core/forecasting/` | Current for protected model/run API inputs, cursors, repository, and service; worker execution remains planned |
