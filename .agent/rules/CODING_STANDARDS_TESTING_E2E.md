# Cloud Commitment Portfolio Optimizer — Coding Standards: E2E Testing (Real Endpoints)

> Part 5 of 5. Related core/meta/testing/live/domain rules exist; load them only when the task touches those surfaces.
